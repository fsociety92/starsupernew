...
import im.vector.app.features.home.CloudShareActivity
import im.vector.app.features.home.CloudStorageActivity
...
class VectorSettingsActivity : VectorBaseActivity<ActivityVectorSettingsBinding>(),
    ...
    override fun onPreferenceStartFragment(caller: PreferenceFragmentCompat, pref: Preference): Boolean {
        ...
        if (pref.toString() == getString(R.string.change_city)) {
            ...
            finish()
            return true
        } else if (pref.toString() == getString(R.string.cloud_storage)) {
            SessionManager.session = session
            startActivity(Intent(applicationContext, CloudStorageActivity::class.java))
            finish()
            return true
        } else if (pref.toString() == getString(R.string.send_file)) {
            SessionManager.session = session
            startActivity(Intent(applicationContext, CloudShareActivity::class.java))
            finish()
            return true
        }
        val oFragment = try {
